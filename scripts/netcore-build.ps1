...
dotnet publish .\CollectSFData.core.csproj -r win-x64 -c Debug --no-dependencies -p:PublishedTrimmed=true
dotnet publish .\CollectSFData.csproj -r win-x64 -c Debug --no-dependencies -p:PublishedTrimmed=true
