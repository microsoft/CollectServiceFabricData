...
#>
param(
    [string]$module = (resolve-path "$psscriptroot/../src/bin/debug/net7.0/collectsfdatadll.dll"),
    [string]$collectsfdataOptionsFile = (resolve-path "$psscriptroot/../src/bin/debug/net7.0/collectsfdata.options.json")
)
